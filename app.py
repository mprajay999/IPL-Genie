...
@app.route('/calculate')
def calculate():
    return render_template('Calculate.html',m='Team A rating = (1-(0.1*position of team A on points table))+(No. of matches Team A has won Against Team B in the past / Total no. of Matches Played Between Team A and Team B)',
